...
public abstract class AColumnFamily
{
    ...
    int getColumnCount()
    {
        ...
        {
            for(IColumn column : getColumns().values())
            {
    ...
    public ColumnFamily diff(AColumnFamily cfComposite)
    {
        ...
        SortedMap<byte[],IColumn> columns = getColumns();
        for (Map.Entry<byte[], IColumn> entry : cfComposite.getColumns().entrySet())
        {
            byte[] cName = entry.getKey();
            IColumn columnInternal = columns.get(cName);
    ...
    public String toString()
    {
    	...
    	sb.append(" [");
        sb.append(getComparator().getColumnsString(getColumns().values()));
        sb.append("])");
    ...
    /**
     * Returns an optionally mutable SortedMap representing the columns in this family.
     */
    public abstract SortedMap<byte[],IColumn> getColumns();

    /**
     * Returns a mutable clone of the columns in this family.
     */
