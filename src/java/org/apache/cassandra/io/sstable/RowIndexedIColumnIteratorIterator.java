 ...
 */
@Deprecated
public class RowIndexedIColumnIteratorIterator implements Iterator<IColumnIterator>,Closeable
{
    private static Logger logger = LoggerFactory.getLogger(RowIndexedIColumnIteratorIterator.class);

    private final BufferedRandomAccessFile file;
    private final RowIndexedReader sstable;
     ...
     */
    RowIndexedIColumnIteratorIterator(RowIndexedReader sstable, int bufferSize)
    {
        try
        {
     ...
     */
    RowIndexedIColumnIteratorIterator(RowIndexedReader sstable, QueryFilter filter, int bufferSize)
    {
        try
        {
            this.file = new BufferedRandomAccessFile(sstable.getFilename(), "r", bufferSize);
