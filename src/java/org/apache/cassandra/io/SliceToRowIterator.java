 ...
 */
@Deprecated
public class SliceToRowIterator extends ReducingIterator<SliceBuffer, Row> implements PeekingIterator<Row>, Closeable
{
    ...
    public SliceToRowIterator(Iterator<SliceBuffer> source, SSTableReader reader)
    {
        super(source);
        this.reader = reader;
