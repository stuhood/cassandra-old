...
public abstract class RowIndexedTestBase extends CleanupHelper
{
    ...
    public void testSingleWrite() throws IOException {
        // write test data
        DecoratedKey key = Util.dk(Integer.toString(1));
    ...
    protected abstract void verifySingle(RowIndexedReader sstable, byte[] bytes, DecoratedKey key) throws IOException;
    ...
    protected abstract void verifyMany(RowIndexedReader sstable, TreeMap<DecoratedKey, ColumnFamily> map) throws IOException;
    ...
    protected abstract void verifyManySuper(RowIndexedReader sstable, TreeMap<DecoratedKey, ColumnFamily> map) throws IOException;
}
